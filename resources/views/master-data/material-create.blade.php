                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="roundText">Material Name <span class="text-danger">*</span></label>
                            <input type="text" id="roundText"
                                class="form-control round @error('material_name') is-invalid @enderror" placeholder="Material Name"
                                name="material_name" value="{{ old('material_name', $isEdit ? $material->material_name : '') }}" />
                            @error('material_name')
